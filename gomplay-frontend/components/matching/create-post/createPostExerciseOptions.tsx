  ...
  [
    {
      value: "당구",
      label: "당구",
      icon: () => <MaterialCommunityIcons name="billiards-rack" size={28} color="#EF5A24" />,
    },
    {
      value: "야구",
      label: "야구",
    ...
    },
    {
      value: "테니스",
      label: "테니스",
      icon: () => <MaterialCommunityIcons name="tennis-ball" size={28} color="#58B95C" />,
    },
    {
      value: "등산",
      label: "등산",
    ...
    },
    {
      value: "배드민턴",
      label: "배드민턴",
      icon: () => <MaterialCommunityIcons name="badminton" size={28} color="#3E8D53" />,
    },
    {
      value: "헬스",
      label: "헬스",
