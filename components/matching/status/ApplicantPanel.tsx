...
const PANEL_WIDTH = Math.round(SCREEN_WIDTH * 0.86);
      ...
      <View style={styles.cardTop}>
        ...
        <View style={styles.cardInfo}>
          <View style={styles.nameRow}>
            ...
            <Text style={styles.studentNo}>{applicant.studentNumber}</Text>
            <Text style={styles.dept}>{applicant.department}</Text>
          </View>
